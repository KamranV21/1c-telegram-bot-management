---
sidebar_position: 4
title: Пример произвольного сценария
description: Полный пример кода на языке 1С для интеграции с Telegram
keywords: [1С, Telegram, язык программирования 1С, пример, произвольная логика]
---
