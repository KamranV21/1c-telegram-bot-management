...
Функция ОдноразовыйПарольАвторизацииЧата(Сценарий) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
						  |	TBM_ОдноразовыеПаролиАвторизацииЧатовTelegram.Пароль,
						  |	TBM_ОдноразовыеПаролиАвторизацииЧатовTelegram.ДействителенДо
						  |ИЗ
						  |	РегистрСведений.TBM_ОдноразовыеПаролиАвторизацииЧатовTelegram КАК TBM_ОдноразовыеПаролиАвторизацииЧатовTelegram
						  |ГДЕ
						  |	TBM_ОдноразовыеПаролиАвторизацииЧатовTelegram.Сценарий = &Сценарий
						  |	И TBM_ОдноразовыеПаролиАвторизацииЧатовTelegram.ДействителенДо > &ТекущаяДатаСеанса");
