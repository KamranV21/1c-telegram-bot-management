		...
		Если HTTPОтвет <> Неопределено Тогда
			...
			Если ЗначениеЗаполнено(ТелоОтвета) Тогда
				ЗаписьЖурналаРегистрации(ИмяСобытия, УровеньЖурналаРегистрации.Ошибка,
					ПараметрыHTTPЗапроса.Бот.Метаданные(), ПараметрыHTTPЗапроса.Бот, СтрШаблон(НСтр(
...
Процедура ВыполнитьСценарийИОтправитьСообщениеВЧат(Бот, ВыборкаСценарии, НовыеЧаты)
	...
	Пока ВыборкаЧатов.Следующий() Цикл
		...
		ПараметрыВычисления.Вставить("НаименованиеЧата", ВыборкаЧатов.НаименованиеЧата);
		ПараметрыВычисления.Вставить("ТипЧата", ВыборкаЧатов.ТипЧата);
