...
Функция ОтправитьСообщениеВЧат(Бот, Сообщение) Экспорт
	...
	Если Не ЗначениеЗаполнено(Сообщение.reply_markup) Тогда
		Сообщение.reply_markup = НоваяСтруктураУдаленияКлавиатуры();
	КонецЕсли;
...
// * text - Строка
// * parse_mode - Строка
// * reply_markup - Неопределено,Структура: см. НоваяКлавиатураПредоределенногоОтвета,Структура:см. НоваяСтруктураУдаленияКлавиатуры
...
Функция НоваяСтруктураУдаленияКлавиатуры() Экспорт
...
Процедура ВыполнитьЭтапОбщения(Общение, ПараметрыВыполненияЭтапа)
	...
	Попытка
		...
		Если ЗначениеЗаполнено(Результат.Сообщение.Текст) Тогда
			...
			Клавиатура = НоваяСтруктураУдаленияКлавиатуры();
