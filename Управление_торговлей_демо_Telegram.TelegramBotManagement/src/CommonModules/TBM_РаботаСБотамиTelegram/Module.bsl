		...
		Иначе
			...
			Пока ВыборкаЧаты.Следующий() Цикл
				...
				Если ТекущиеОбщенияСЧатами.НайтиСледующий(СтруктураПоиска) Тогда
					...
					ПараметровВыполненияЭтапа.ПроизвольныйКод = ТекущиеОбщенияСЧатами.ПроизвольныйКод;
					ВыполнитьЭтапОбщения(ПараметровВыполненияЭтапа);
				Иначе
...
Процедура ВыполнитьЭтапОбщения(ПараметровВыполненияЭтапа)

	Бот = ПараметровВыполненияЭтапа.Бот;
	Чат = ПараметровВыполненияЭтапа.Чат;
	ИдентификаторЧата = ПараметровВыполненияЭтапа.ИдентификаторЧата;
	ИдентификаторСообщения = ПараметровВыполненияЭтапа.ИдентификаторСообщения;
	ТекстСообщения = ПараметровВыполненияЭтапа.ТекстСообщения;
	ПроизвольныйКод = ПараметровВыполненияЭтапа.ПроизвольныйКод;

	Результат = Новый Структура;
	Результат.Вставить("Ответ", "");
	Результат.Вставить("Документы", Новый Массив);

	ВыполнитьПроизвольныйКод(ПроизвольныйКод, ПараметровВыполненияЭтапа, Результат);
	...
	СохранитьОбработанноеСообщение(Бот, Чат, Сообщение);
...
Функция НоваяСтруктураПараметровВыполненияЭтапа()
	...
	ПараметровВыполненияЭтапа.Вставить("ИдентификаторЧата", "");
	...
	ПараметровВыполненияЭтапа.Вставить("ИдентификаторСообщения", "");
...
Процедура ЗавершитьЭтапОбщения(Общение, НаименованиеЭтапа) Экспорт
	...
	ОбщениеОбъект.Завершено = ОбщениеОбъект.Этапы.НайтиСтроки(СтруктураПоиска).Количество() = 0;
