...
Процедура ОтветитьНаПолученныеСообщения(Бот, ТаблицаСообщений) Экспорт
	...
	Запрос.УстановитьПараметр("СценарийАвторизацииЧата", СценарийАвторизацииЧата());
...
#Область АвторизацияЧатов

Функция СценарийАвторизацииЧата()

	Возврат Справочники.TBM_СценарииБотовTelegram.НайтиПоНаименованию("Авторизация");
