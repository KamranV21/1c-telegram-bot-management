...
Функция УстановитьВебхукБота()
	...
	ПараметрыВебхука = TBM_РаботаСБотамиTelegram.ПараметрыВебхука();
	ПараметрыВебхука.url = Объект.АдресВебхука;
	ПараметрыВебхука.secret_token = Объект.СекретВебхука;

	Возврат TBM_РаботаСБотамиTelegram.УстановитьВебхук(Объект.Ссылка, ПараметрыВебхука);
...
Функция ОтключитьВебхукБота()
	...
	Возврат TBM_РаботаСБотамиTelegram.ОтключитьВебхук(Объект.Ссылка);
...
Функция УстановитьКомандыБота()
	...
	Возврат TBM_РаботаСБотамиTelegram.УстановитьОбщиеКомандыБота(Объект.Ссылка);
...
Функция УдалитьКомандыБота()
	...
	Возврат TBM_РаботаСБотамиTelegram.УдалитьОбщиеКомандыБота(Объект.Ссылка);
...
Процедура НастроитьЭлементыРегламентногоЗадания()
	...
	Если Объект.ВариантВзаимодействия = Перечисления.TBM_ВариантыВзаимодействияСБотамиTelegram.РегламентноеЗадание Тогда
