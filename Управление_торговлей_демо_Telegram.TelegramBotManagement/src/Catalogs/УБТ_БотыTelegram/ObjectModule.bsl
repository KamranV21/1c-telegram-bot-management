...
Процедура ВключитьОтключитьРегламентноеЗадание(РасписаниеРегламентногоЗадания) Экспорт
	...
	Если ВариантВзаимодействия = Перечисления.УБТ_ВариантыВзаимодействияСБотамиTelegram.РегламентноеЗадание Тогда

		УБТ_РаботаСБотамиTelegram.ОтключитьВебхук(Ссылка);
		...
		Если Задание = Неопределено Тогда
			...
			ПараметрыЗадания.Вставить("Метаданные", Метаданные.РегламентныеЗадания.УБТ_ВзаимодействиеСБотамиTelegram);
...
Функция СвойстваЗадания(РасписаниеЗадания = Неопределено) Экспорт
	...
	ПараметрыЗадания.Вставить("ИмяМетода", Метаданные.РегламентныеЗадания.УБТ_ВзаимодействиеСБотамиTelegram.ИмяМетода);
...
Функция СуществующееЗадание() Экспорт
	...
	Отбор.Вставить("Метаданные", Метаданные.РегламентныеЗадания.УБТ_ВзаимодействиеСБотамиTelegram);
